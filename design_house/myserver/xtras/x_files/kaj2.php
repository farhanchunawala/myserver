...
<div class="container-fluid">
	...
	<?php for($i = 0; $i < $garbcount; $i++) { ?>
		...
		<tr>
			...
			<td>	<div class="form-check-inline">   <label class="form-check-label" for="kaj<?php echo $g; ?>">
						<input type="hidden"							id="kaj<?php echo $i; ?>" name="kaj<?php echo $i; ?>" value="unchecked">
						<input type="checkbox" class="form-check-input" id="kaj<?php echo $i; ?>" name="kaj<?php echo $i; ?>" value="checked" <?php echo "$garb_kaj[$i]"; ?>>
			</label>   </div>   </td>
			</tr>
