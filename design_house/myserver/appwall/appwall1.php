...
<head> <title>Z&M App Wall</title>
	<?php $fdir='../';  include $fdir.'svr/filepath.php';  include $bootstrapcdn_php;  $svr_mode='svr_kkms'; ?>
</head>
<body>
<?php $navtitle='ZOLL & METÉR';  $navlink=$appwall_php;  include $navbar_php; ?>
	...
	<div class="d-flex flex-wrap align-content-around">
		<a class="btn btn-outline-secondary m-2" href=<?php echo $designer_php			."?svr_mode=svr_designhouse";?>		  	 		style="width:94px; height:94px; display:flex; justify-content:center; align-items:center" ><b>Designer</b></a>
		<a class="btn btn-outline-secondary m-2" href=<?php echo $designlist_php		."?svr_mode=svr_designhouse";?>		  	 		style="width:94px; height:94px; display:flex; justify-content:center; align-items:center" ><b>Design List</b></a>
	</div>
	</div>
