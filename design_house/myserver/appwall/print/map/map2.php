<?php
	...
	$x_sb_m = $x_clothln - 0.5;						$y_sb_m = $y_pana - $y_sb_bottom;
	$vertex = 'G';			$sb_rotate=0;			$fill='lightblue';		$opacity=1;
	include $p_shirt_back_php;
	
	$x_ss_m = $x_ss_hala + 0.5;						$y_ss_m = 0;
	$vertex = 'D';			$ss_rotate=180;		$fill='lightblue';		$opacity=1;
