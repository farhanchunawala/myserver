<?php
	if ($x_pf_length <= 30 ) include $fn_scale_print1x30_php;
	elseif ($x_pf_length > 30 && $x_pf_length <= 35) include $fn_scale_print1x35_php;
	elseif ($x_pf_length > 35 && $x_pf_length <= 40) include $fn_scale_print1x40_php;
	elseif ($x_pf_length > 40 && $x_pf_length <= 45) include $fn_scale_print1x45_php;
	elseif ($x_pf_length > 45 && $x_pf_length <= 50) include $fn_scale_print1x50_php;
