...
<div id='mar1'>
	...
	<div class="row mb-1 no-gutters">
		...
		<?php
			if ($cuffln[1]=="0") echo "";
			else 				 echo inchtotext($cuffbr)." x ".inchtotext($cuffln[1]);
		?>
		</div>
		<div class="col">
		<?php
			if ($pocket=="pocketa") echo "4 x 4½";
			elseif ($pocket=="pocketb") echo "4¼ x 4¾";
			elseif ($pocket=="pocketc") echo "4½ x 5¼";
			elseif ($pocket=="pocketd") echo "4¾ x 5½";
			elseif ($pocket=="pockete") echo "5 x 5¾";
			elseif ($pocket=="pocketf") echo "5¼ x 6";
			elseif ($pocket=="pocketg") echo "5½ x 6¼";
			elseif ($pocket=="pocketh") echo "5¾ x 6½";
			else echo "";
		?>
		</div>
	</div>
	<div class="row mb-n3 no-gutters">
		<div class="col">
			<?php
			if ($sleevefit=="slm") 	   echo "SL= ".inchtotext($biceps);
			elseif ($sleevefit=="sl")  echo "SL ".inchtotext($biceps);
			elseif ($sleevefit=="slp") echo "SL+ ".inchtotext($biceps);
			elseif ($sleevefit=="sm")  echo "SM ".inchtotext($biceps);
			elseif ($sleevefit=="smp") echo "SM+ ".inchtotext($biceps);
			elseif ($sleevefit=="sf")  echo "SF ".inchtotext($biceps);
			elseif ($sleevefit=="sfp") echo "SF+ ".inchtotext($biceps);
			else 					   echo inchtotext($biceps);
			?>
		</div>
		<div class="col"></div>
		<div class="col" style="font-size:19px">
			<?php
			if ($shouldertype[1]=="noshoulder") echo "NO Shoulder";
			elseif ($shouldertype[1]=="vshoulder") echo "V Shoulder";
			elseif ($shouldertype[1]=="dvshoulder") echo "DV Shoulder";
			else echo "";
			?>
		</div>
		<div class="col"></div>
		...
		<div class="col" style="font-size:19px">
			<?php
			if ($collartype[1]=="lspc") echo "LSPC";
			elseif ($collartype[1]=="rmpc") echo "RMPC";
			elseif ($collartype[1]=="mrmpc") echo "MRMPC";
			elseif ($collartype[1]=="bc") echo "BC";
			elseif ($collartype[1]=="nocollar") echo "NO Collar";
			else echo "";
			?>
		</div>
		<div class="col" style="font-size:19px">
			<?php
			if ($cufftype[1]=="nocuff") echo "NO Cuff";
			elseif ($cufftype[1]=="cut") echo "Cut";
			elseif ($cufftype[1]=="square") echo "SQUARE";
			elseif ($cufftype[1]=="round") echo "ROUND";
			else echo "";
			?>
		</div>
		<div class="col" style="font-size:19px">
			<?php
			if ($pockettype[1]=="nopocket") echo "NO Pocket";
			elseif ($pockettype[1]=="square") echo "SQUARE";
			elseif ($pockettype[1]=="v") echo "V";
			elseif ($pockettype[1]=="round") echo "ROUND";
			elseif ($pockettype[1]=="flap") echo "FLAP";
			elseif ($pockettype[1]=="wallet") echo "WALLET";
			else echo "";
			?>
		</div>
	</div>
...
<div id='mar1'>
	...
	<div class="row mb-n4 no-gutters">
		...
		<div class="col">
			<?php
			if ($plits=="0") echo "<u>No plts</u>";
			else echo "<u>$plits"."plts</u>";
			?>
		</div>
	</div>
	<div class="row mb-n2 no-gutters">
	...
	<div class="row no-gutters">
		<div class="col">
			<?php
			if ($crease=="fc") echo "FC";
			elseif ($crease=="sc") echo "SC";
			?>
		</div>
		<div class="col"></div>
		<div class="col"></div>
	...
	<div class="row no-gutters">
		...
		<div class="col">
			<?php
			if ($belt=="lbelt") echo "L blt";
			elseif ($belt=="cbelt") echo "C blt";
			?>
		</div>
